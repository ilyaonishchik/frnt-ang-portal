...
@NgModule({
  declarations: [ReadComponent, PermissionComponent, CreateComponent],
  imports: [
    CommonModule,
    EffectsModule.forFeature([GetPermissionEffect, CreatePermissionEffect]),
  ...
  exports: [ReadComponent, PermissionComponent, CreateComponent],
})
